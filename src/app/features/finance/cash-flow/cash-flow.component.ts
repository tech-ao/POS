...
import { cashFlow } from '../../../shared/model/page.model';
...
export class CashFlowComponent {
  ...
  public tableData: Array<cashFlow> = [];
  public tableData2: Array<cashFlow> = [];
  ...
  constructor(
    ...
    private getTableData(pageOption: pageSelection): void {
      this.data.getCashFlow().subscribe((apiRes: apiResultFormat) => {
        this.tableData = [];
        this.serialNumberArray = [];
        this.totalData = apiRes.totalData;
        apiRes.data.map((res: cashFlow, index: number) => {
        ...
        this.dataSource = new MatTableDataSource<cashFlow>(this.tableData);
