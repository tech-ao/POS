...
import { routes, DataService, pageSelection, apiResultFormat, SidebarService } from '../../../../core/core.index';
import { currencySettings } from '../../../../shared/model/page.model';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule,MatSortModule,MatTableModule,MatSelectModule,FormsModule,SettingsSidebarComponent]
})
