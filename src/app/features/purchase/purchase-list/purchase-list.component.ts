...
import { purchaseList } from '../../../shared/model/page.model';
...
@Component({
    ...
    imports: [CommonModule,CustomPaginationComponent,MatSelectModule,FormsModule,MatSortModule,NgxEditorModule,BsDatepickerModule]
})
