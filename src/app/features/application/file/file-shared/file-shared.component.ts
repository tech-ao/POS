...
import { fileShared } from '../../../../shared/model/page.model';
...
@Component({
    ...
    imports: [NgxEditorModule,CustomPaginationComponent,RouterLink,FormsModule,MatSortModule,MatSelectModule,CommonModule]
})
