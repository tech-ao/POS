...
@Component({
    selector: 'app-file-archived',
    templateUrl: './file-archived.component.html',
    styleUrl: './file-archived.component.scss',
     imports: [CustomPaginationComponent,RouterLink,FormsModule,DragDropModule,MatSortModule,MatSelectModule,CommonModule]
})
export class FileArchivedComponent {
  ...
  constructor(
    ...
    this.data.getDataTable().subscribe((apiRes: apiResultFormat) => {
      ...
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.fileArchived) {
