...
import { inventoryreport, stockHistory } from '../../../shared/model/page.model';
...
export class StockHistoryComponent {
 initChecked = false;
  ...
  public tableData: Array<stockHistory> = [];
  public pageSize = 10;
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getStockHistory().subscribe((apiRes: apiResultFormat) => {
      this.tableData = [];
      this.serialNumberArray = [];
      this.totalData = apiRes.totalData;
      apiRes.data.map((res: stockHistory, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<stockHistory>(this.tableData);
