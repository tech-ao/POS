...
import {  soldStock } from '../../../shared/model/page.model';
...
export class SoldStockComponent {
 initChecked = false;
  ...
  public tableData: Array<soldStock> = [];
  public pageSize = 10;
  public serialNumberArray: Array<number> = [];
  public totalData = 0;
  showFilter = false;
  dataSource!: MatTableDataSource<soldStock>;
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getSoldStock().subscribe((apiRes: apiResultFormat) => {
      ...
      this.totalData = apiRes.totalData;
      apiRes.data.map((res: soldStock, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<soldStock>(this.tableData);
