...
import { rolesPermissions } from '../../../shared/model/page.model';
...
@Component({
    ...
    imports: [MatSelectModule,CustomPaginationComponent,FormsModule,MatSortModule,CommonModule,RouterLink]
})
