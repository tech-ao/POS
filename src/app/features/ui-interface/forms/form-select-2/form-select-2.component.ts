...
@Component({
    ...
    styleUrls: ['./form-select-2.component.scss'],
    imports: [CommonModule, FormsModule, ReactiveFormsModule,MatSelectModule,MatAutocompleteModule,MatChipsModule,MatIconModule,RouterLink]
})
