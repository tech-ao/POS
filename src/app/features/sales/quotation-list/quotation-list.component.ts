...
import { quotationList } from '../../../shared/model/page.model';
...
@Component({
    ...
    imports: [NgxEditorModule,MatSelectModule,CommonModule,FormsModule,CustomPaginationComponent,MatSortModule,BsDatepickerModule]
})
