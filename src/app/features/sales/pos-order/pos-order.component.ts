...
@Component({
  ...
  imports: [NgxEditorModule,MatSelectModule,CommonModule,FormsModule,CommonCounterComponent,CustomPaginationComponent,MatSortModule,BsDatepickerModule]
})
  ...
  constructor(
    ...
    this.data.getDataTable().subscribe((apiRes: apiResultFormat) => {
      ...
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.posOrder) {
